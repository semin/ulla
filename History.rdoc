== 0.9.0, released version

* Added --heatmap option to generate heat maps from substitution tables
* Added --heatmap-format option has been added for heat map figure format (PNG, GIF, JPG, BMP, and PDF)
* Added --heatmap-stem option has been added to set a file name for total heat maps figure when --heatmap 1 or 2 is set
* Added --heatmap-columns option has been added to set the number of tables in a row when --heatmap 1 or 2 is set
* Added --heatmap-value option has been added to print values in the cells of heat maps
* Added --noround option has been renamed to --noroundoff
